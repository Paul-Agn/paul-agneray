...
function carteHtml(lieu) {
  const q = encodeURIComponent(lieu);
  return '<div class="carte">' +
    '<iframe src="https://www.google.com/maps?q=' + q + '&amp;output=embed&amp;hl=fr" title="Carte : ' + lieu + '" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>' +
    '<p class="lieu">' + lieu + ' · <a href="https://www.google.com/maps/search/?api=1&amp;query=' + q + '" target="_blank" rel="noopener">Ouvrir dans Google Maps</a></p>' +
    '</div>';
}
